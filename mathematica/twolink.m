(*
 * twolink.m - calculations for planar, two-link manipulator
 * 
 * Richard M. Murray
 * 8 July 91
 *
 * The calculations contained here are used in various chapters of the book
 * as part of examples and problems.
 *
 *)

<<Jac.m				(* package for evaluating derivatives *)
<<RobotLinks.m			(* for inertia to Coriolis fcn *)
...
beta = Together[(Inertia[[1,1]] - alpha) /. th2 -> 0];
gamma = Inertia[[2,2]];
